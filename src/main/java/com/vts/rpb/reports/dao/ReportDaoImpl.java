...
public class ReportDaoImpl implements ReportDao
{
	...
	public List<Object[]> estimateTypeParticularDivList(String divisionId, String estimateType,String finYear, String loginType,String empId, String budget,String proposedProject, String budgetHeadId, String budgetItemId,
		...
		try {
			...
			System.out.println("CALL Ibas_EstimateTypeParticularDivList_Rpt('"+finYear+"', '"+divisionId+"', '"+estimateType+"', '"+loginType+"', '"+empId+"', '"+proposedProject+"', '"+budget+"', '"+budgetHeadId+"', '"+budgetItemId+"', '"+fromCost+"', '"+toCost+"', '"+status+"', '"+memberType+"', '"+RupeeValue+"');");
			Query query= manager.createNativeQuery("CALL Ibas_EstimateTypeParticularDivList_Rpt(:finYear, :divisionId, :estimateType, :loginType, :empId, :proposedProject, :budget, :budgetHeadId, :budgetItemId, :fromCost, :toCost, :status, :memberType, :rupeeValue)");
	...
	public List<Object[]> getFundReportList(String finYear, String divisionId, String estimateType, String loginType,String empId, String  budget,String proposedProject, String budgetHeadId, String budgetItemId,
		...
		try {
			...
			System.out.println("CALL Ibas_FundReportList_Rpt('"+finYear+"', '"+divisionId+"', '"+estimateType+"', '"+loginType+"', '"+empId+"', '"+proposedProject+"', '"+budget+"', '"+budgetHeadId+"', '"+budgetItemId+"', '"+fromCost+"', '"+toCost+"', '"+status+"', '"+committeeMember+"', '"+RupeeValue+"');");
			Query query= manager.createNativeQuery("CALL Ibas_FundReportList_Rpt(:finYear, :divisionId, :estimateType, :loginType, :empId, :proposedProject, :budget, :budgetHeadId, :budgetItemId, :fromCost, :toCost, :status, :memberType, :rupeeValue)");
